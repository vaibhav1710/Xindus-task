...
public class UserRepositoryImpl implements UserRepository {
    ...
    private static final String SQL_CREATE = "INSERT INTO TA_USERS(USER_ID, FIRST_NAME, LAST_NAME, EMAIL , PASSWORD) VALUES(NEXTVAL('TA_USERS_USER_ID_SEQ'),?,?,?,?)";
